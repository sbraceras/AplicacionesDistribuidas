...
alter table Manos add constraint fk_manos_chico foreign key(id_chico) references Chico (id_mano)
...
----------------------------------------
--------------------------
drop table Movimientos ----------eliminar estooooooo --------------
-----------------------------
-----------------------------
...
alter table CartasJugador add constraint fk_cartasJugador_carta foreign key(id_carta) references Jugadores (id_carta)
...
alter table Ranking add constraint fk_rankings_jugador foreign key(id_jugador) references Jugadores (id_jugador)
...
alter table Ranking_Partido add constraint fk_id_jugador_jugadores foreign key(id_jugador) references Jugadores (id_jugador)
