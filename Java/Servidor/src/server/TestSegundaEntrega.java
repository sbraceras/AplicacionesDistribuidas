...
public class TestSegundaEntrega {
	...
	/*	ArrayList<JugadorDTO> jugadores = ServicioCentral.getInstance().obtenerJugadores();
		...
		jugador1.setMail("abc");

		jugador2.setId(4);
		jugador2.setApodo("sbraceras");
		jugador2.setPassword("TaTobrA");
		jugador2.setMail("abcd");
		
		jugador3.setId(5);
		jugador3.setApodo("gmasaro");
		jugador3.setPassword("banfieldcapo");
		jugador3.setMail("abce");
		
		jugador4.setId(6);
		jugador4.setApodo("ozamudio");
		jugador4.setPassword("yousomac");
		jugador4.setMail("abcf");

		
/*  REGISTRACION
 
		try {
			ServicioCentral.getInstance().registrarJugador(jugador1);
		} catch (JugadorException e1) {
			// TODO Auto-generated catch block
			e1.printStackTrace();
		}
		try {
			ServicioCentral.getInstance().registrarJugador(jugador2);
		} catch (JugadorException e1) {
			// TODO Auto-generated catch block
			e1.printStackTrace();
		}
		try {
			ServicioCentral.getInstance().registrarJugador(jugador3);
		} catch (JugadorException e1) {
			// TODO Auto-generated catch block
			e1.printStackTrace();
		}
		try {
			ServicioCentral.getInstance().registrarJugador(jugador4);
		} catch (JugadorException e1) {
			// TODO Auto-generated catch block
			e1.printStackTrace();
		}
